...
int main(){
    ...
    // Просмотр изначального контейнера 1, 2 пункты задания
    ...
    // Просмотр измененнного контейнера 3, 4 пункты задания
    ...
    // Удаление элементов из 1 контейнера и перенос из второго контейнера 6, 7 пункты задания
